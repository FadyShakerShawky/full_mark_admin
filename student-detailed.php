                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 row">
                                        ...
                                        <span class="col-6"><?php echo $userData["u_fname"];
                                        ?></span>
                                        <span class="col-6">Last name</span>
                                        <span class="col-6"><?php echo $userData["u_lname"];
                                        ?></span>
                                        <span class="col-6">Email</span>
                                        <span class="col-6"><?php echo $userData["u_email"];
                                        ?></span>
                                    </div>
                                    <div class="col-md-6 row">
                                        <span class="col-6">Verified</span>
                                        <span class="col-6"><?php echo $userData["u_verified"];
                                        ?></span>
